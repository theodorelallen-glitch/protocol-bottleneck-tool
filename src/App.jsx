...
const AUDIT_URL = "https://project-theo.com/pages/protocol-audit";
...
const styles = `
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .pt-pill-outline { display: block; background: transparent; color: #e8e0d0; font-family: 'Jost', sans-serif; font-weight: 400; font-size: 14px; letter-spacing: 0.5px; padding: 16px 32px; text-align: center; cursor: pointer; border: 1px solid rgba(232,224,208,0.45); border-radius: 50px; width: 100%; margin-top: 16px; transition: background 0.2s, transform 0.15s; text-decoration: none; }
  .pt-pill-outline:hover { background: rgba(232,224,208,0.08); transform: translateY(-1px); }
  ...
  .pt-gate-body { font-size: 14px; line-height: 1.75; color: rgba(232,224,208,0.65); margin-bottom: 20px; }
  .pt-gate-guides { margin-bottom: 32px; }
  .pt-gate-guides-label { font-size: 10px; letter-spacing: 2px; text-transform: uppercase; color: rgba(232,224,208,0.4); margin-bottom: 12px; }
  .pt-gate-guide-link { display: block; font-size: 13px; color: rgba(232,224,208,0.6); text-decoration: none; padding: 6px 0; border-bottom: 1px solid rgba(232,224,208,0.08); transition: color 0.2s; }
  .pt-gate-guide-link:last-child { border-bottom: none; }
  .pt-gate-guide-link:hover { color: #e8e0d0; }
  ...
  .pt-audit-block { background: rgba(232,224,208,0.03); border: 1px solid rgba(232,224,208,0.1); padding: 28px 24px; margin-top: 16px; border-radius: 2px; }
  .pt-cta-label { font-size: 10px; letter-spacing: 3px; text-transform: uppercase; color: rgba(232,224,208,0.45); margin-bottom: 12px; }
  .pt-cta-text { font-size: 14px; line-height: 1.75; color: rgba(232,224,208,0.65); margin-bottom: 10px; }
  .pt-audit-text { font-size: 14px; line-height: 1.75; color: rgba(232,224,208,0.65); margin-bottom: 10px; }
  .pt-audit-text-sub { font-size: 14px; line-height: 1.75; color: rgba(232,224,208,0.55); margin-bottom: 0; }
...
const RESULTS = {
  r_pre_foundation_sleep: { tag: "Foundation — Sleep", title: "Sleep is the first variable that needs to be stable — not the first compound to add.", body: "GLP-1 compounds, GH secretagogues, and metabolic peptides all work through hormonal signaling pathways that sleep governs directly. Growth hormone is released primarily during slow-wave sleep. Cortisol, which suppresses fat mobilization and disrupts metabolic signaling, is regulated overnight. A researcher averaging under six hours or consistently poor quality sleep is starting inside a hormonal environment that actively works against what these compounds are designed to do. The compound will still have an effect — but it will be a fraction of what the research literature documents, and the result will not be readable enough to make informed decisions from.", whatItMeans: "The Research Protocol Bible covers the Foundation Gate with sleep as the first check — specifically what inadequate sleep does to GLP-1 response, GH pulse amplitude, and cortisol patterning, and the practical steps to stabilize it before any protocol begins." },
  r_pre_foundation_protein: { tag: "Foundation — Protein Intake", title: "Protein is the substrate lean mass preservation compounds are trying to work with — without it, they have nothing to protect.", body: "Caloric restriction tells the body to break down stored energy. Fat is the target, but without an adequate protein signal, muscle is broken down alongside it. GH secretagogues and lean mass support compounds work by sending a preservation signal — but that signal requires adequate protein as the raw material. Research consistently shows that lean mass outcomes on fat loss protocols are more dependent on protein adequacy than on any support compound.", whatItMeans: "The Research Protocol Bible covers protein as a Foundation Gate variable — the specific intake targets relative to lean body mass, why GLP-1-driven appetite suppression so commonly pulls protein down alongside calories, and how to correct intake without disrupting the caloric environment driving fat loss." },
  r_pre_foundation_stimulant: { tag: "Foundation — Stimulant Load", title: "Daily stimulant use sets a cortisol ceiling that no compound can work above.", body: "Stimulants drive their effect through cortisol and catecholamine release — the same stress hormones that suppress fat mobilization, disrupt sleep architecture, and compete directly with the signaling pathways that metabolic compounds depend on. A researcher using stimulants daily to reach baseline function has a chronically elevated cortisol baseline. Every compound they add is working against that baseline rather than within a stable environment.", whatItMeans: "The Research Protocol Bible covers the stimulant load variable in the Foundation Gate — what chronic use does to the cortisol baseline, how it contaminates the protocol read, and the correct sequencing for reducing stimulant dependence before starting any compound." },
  r_pre_foundation_sleep_protein: { tag: "Foundation — Sleep and Protein", title: "Two foundation gaps running at the same time means any compound result will be unreadable.", body: "Sleep deprivation suppresses the hormonal environment that compounds work through. Inadequate protein removes the substrate that lean mass preservation depends on. When both are present before a protocol starts, the compound is being added to a system that is already actively losing the battle on two fronts.", whatItMeans: "The Research Protocol Bible covers both gaps in the Foundation Gate and the order in which to address them — sleep first because it governs protein synthesis efficiency, protein second because correcting intake without stable sleep produces a partial fix at best." },
  r_pre_foundation_sleep_stimulant: { tag: "Foundation — Sleep and Stimulant Load", title: "Poor sleep and daily stimulant use are compounding the same cortisol problem from two directions.", body: "Sleep deprivation elevates cortisol independently. Daily stimulant use elevates cortisol independently. When both are present, the cortisol baseline is being sustained from two directions simultaneously, which makes it resistant to compound-level interventions.", whatItMeans: "The Research Protocol Bible covers both of these Foundation Gate variables together — why they compound rather than simply add, what the cortisol ceiling means for compound efficacy specifically, and the practical steps for addressing both before a protocol begins." },
  r_pre_foundation_protein_stimulant: { tag: "Foundation — Protein and Stimulant Load", title: "Low protein and chronically elevated cortisol are pulling lean mass in the same direction before a protocol even starts.", body: "Cortisol from daily stimulant use is catabolic — it signals the body to break down muscle tissue for energy. Inadequate protein removes the substrate needed to rebuild and preserve that tissue. Both inputs are working against lean mass at the same time.", whatItMeans: "The Research Protocol Bible covers the interaction between cortisol load and protein adequacy in the Foundation Gate — why the combination is specifically damaging to lean mass outcomes, and the correct order for addressing both before any compound is introduced." },
  r_pre_foundation_all: { tag: "Foundation — Sleep, Protein, and Stimulant Load", title: "All three foundation gaps are present — a compound will not produce a readable result in this environment.", body: "Sleep deprivation, inadequate protein, and chronic stimulant use each independently reduce compound efficacy. Together they produce a physiological environment where fat mobilization is suppressed, lean mass is actively being broken down, cortisol is chronically elevated, and GH pulsatility is blunted.", whatItMeans: "The Research Protocol Bible covers the full Foundation Gate in sequence — sleep first because it governs everything downstream, protein second because it is the substrate lean mass preservation requires, stimulant load third because correcting it without the first two in place produces an incomplete fix." },
  r_pre_gi_concern: { tag: "Pre-Protocol — Side Effect Awareness", title: "GI symptoms are the most common early challenge and the most manageable.", body: "GLP-1 compounds work partly by slowing gastric emptying — the rate at which the stomach moves food through. That mechanism is also what produces nausea and early GI discomfort in a subset of researchers. Research suggests most GI symptoms are dose and timing variables rather than compound incompatibilities.", whatItMeans: "The Retatrutide guide covers GI symptom management in the context of an active GLP-1 protocol — the three distinct presentations, the dose and timing variables that drive each one, and how to distinguish a manageable titration response from a signal that something else is wrong." },
  r_pre_muscle_concern: { tag: "Pre-Protocol — Lean Mass Preservation", title: "Muscle loss during a fat loss protocol is real — and it is addressable before it starts.", body: "Caloric restriction tells the body to break down stored energy. Without a counteracting signal, that breakdown pulls from both fat and muscle. Research is consistent on what drives lean mass preservation: adequate protein intake, a training stimulus that signals muscle as necessary tissue, and at certain phases a GH secretagogue support layer.", whatItMeans: "The Research Protocol Bible covers lean mass preservation across all four protocol phases — which inputs protect it, when a GH support compound becomes the rational addition, and the sequencing logic that prevents the most common lean mass mistakes on an active fat loss protocol." },
  r_pre_sleep_concern: { tag: "Pre-Protocol — Sleep and Protocol Timing", title: "Sleep disruption from a protocol is almost always a timing variable, not a compound problem.", body: "GLP-1 compounds, particularly retatrutide, activate a glucagon receptor that produces a thermogenic effect. Injecting in the evening or at bedtime means that activation peaks during sleep, which can disrupt sleep architecture. Research suggests morning injection eliminates or significantly reduces sleep disruption for most researchers.", whatItMeans: "The Retatrutide guide covers injection timing in detail — the mechanism behind morning versus evening injection, why timing matters differently for retatrutide than for other GLP-1 compounds, and what the data shows about sleep disruption as a timing variable." },
  r_pre_general_concern: { tag: "Pre-Protocol — Setting Expectations", title: "Understanding what to expect from week one removes most of what makes protocols fail.", body: "The most common reason protocols underperform is not a compound selection problem. It is a misread of what normal looks like. Early water and glycogen shifts inflate apparent fat loss in weeks one through four, then disappear. GI symptoms during titration look like compound intolerance but are almost always dose and timing variables.", whatItMeans: "The Research Protocol Bible covers the full phase framework from the start — what each phase looks like, what normal variation looks like at each stage, and how to read results accurately rather than reacting to them." },
  r_pre_glp1_mechanism: { tag: "Pre-Protocol — Mechanism Clarity", title: "GLP-1 compounds do more than suppress appetite — and understanding the full mechanism changes how you use them.", body: "GLP-1 receptors are found in the gut, brain, and pancreas. The gut signal slows gastric emptying and reduces appetite. The brain signal reduces what researchers call food noise. The pancreatic signal improves insulin sensitivity. Retatrutide adds a third receptor — glucagon — which pushes toward burning stored energy rather than just eating less.", whatItMeans: "The Retatrutide guide and the Research Protocol Bible both cover the mechanism in plain language — what each receptor does, how that translates into observable results, and why the same compound works differently for different researchers." },
  r_pre_phase_logic: { tag: "Pre-Protocol — Phase Framework", title: "The phase framework is what separates researchers who figure it out from those who keep cycling through compounds.", body: "Fat loss does not fail because a compound stops working. It moves through phases, and at each phase the limiting variable shifts. Phase 1 is intake-driven. Phase 2 is output-driven. Phase 3 is recovery-driven. Phase 4 is sleep and GH pulsatility-driven. Adding a Phase 2 compound in Phase 1 adds complexity without benefit.", whatItMeans: "The Research Protocol Bible is built around the phase framework. It covers all four phases in detail — how to identify which one applies, what the rational compound logic is at each stage, and why the sequence matters more than the compound choice." },
  r_pre_compound_match: { tag: "Pre-Protocol — Compound Selection", title: "The right compound is not the strongest one — it is the one that addresses the actual limiting variable.", body: "Semaglutide is the rational starting point when intake is the primary limiting variable. Tirzepatide adds a GIP receptor that produces greater fat loss in head-to-head data. Retatrutide adds a glucagon receptor that drives thermogenesis — the rational next step when a researcher has plateaued and needs a different mechanism.", whatItMeans: "The Research Protocol Bible covers the GLP-1 starting point decision and the compound selection framework in the first chapter — how to identify which compound fits the actual limiting variable before starting, not after the first plateau." },
  r_pre_support_logic: { tag: "Pre-Protocol — Support Compound Logic", title: "A support compound is not an upgrade — it is a tool for a specific bottleneck that does not exist yet.", body: "Support compounds amplify signals that the foundation compound creates. Adding them before the foundation is established means running a more complex protocol without the signal they are designed to amplify. The result is added complexity and cost with no additional benefit.", whatItMeans: "The Research Protocol Bible covers the support compound decision framework — which bottleneck each support compound addresses, when that bottleneck becomes the active limiting variable, and why the sequencing matters more than the compound itself." },
  r_pre_early_researcher: { tag: "Pre-Protocol — Early Research Phase", title: "You are still building the picture — and starting with the right framework matters more than starting fast.", body: "The most common mistake in early research is reaching for a compound decision before the phase and mechanism framework is clear. Researchers who start with a clear understanding of how the phase logic works produce cleaner results and make fewer reactive decisions.", whatItMeans: "The Research Protocol Bible is the logical starting point. It covers the full framework — phase identification, compound selection logic, foundation requirements, and the bottleneck diagnostic system — before any protocol decision is made." },
  r_pre_ready: { tag: "Pre-Protocol — Ready to Start", title: "You have built a research foundation — the next step is confirming the protocol matches the actual limiting variable.", body: "One to three months of research puts you ahead of most people who start. The question at this stage is not whether to start — it is whether the protocol design matches the actual limiting variable in your situation. Most researchers who have done the reading still start with the compound that sounds most interesting rather than the one that addresses the mechanism that is actually limiting their results.", whatItMeans: "The Research Protocol Bible covers the starting point decision and the compound selection framework in detail — how to confirm the match between your limiting variable and the compound mechanism before committing to a protocol." },
  r_pre_ready_experienced: { tag: "Pre-Protocol — Experienced Researcher", title: "Three months of research is a strong foundation — but the gap between knowing the framework and applying it correctly is where most protocols fail.", body: "Experienced researchers often have a clear picture of the compounds but a less clear picture of their own limiting variable. The phase framework is understood conceptually. The question is which phase applies to their specific starting point, and whether the protocol they are planning correctly addresses the mechanism that is actually limiting their results.", whatItMeans: "The Research Protocol Bible covers the compound selection framework from the starting point decision forward — how to identify the actual limiting variable, how to confirm the compound mechanism addresses it, and what the correct Foundation Gate looks like before starting." },
  ...
  r_bn07_stall: { tag: "Bottleneck 07 — Dose Escalation Pattern", title: "A stall that triggered a dose increase is the most common misread in protocol research.", body: "When a plateau leads to dose escalation and the plateau continues, the research is clear: the dose was not the limiting variable. Most plateaus at this stage are Phase 2 metabolic shifts — escalating the intake-suppression mechanism does not address an output bottleneck.", whatItMeans: "The Research Protocol Bible covers the pre-escalation checklist and the Phase 2 assessment that almost always identifies the actual limiting variable." },
...
const MULTI_RESULTS = {
  "energy,fatlose": { tag: "Two Active Bottlenecks", title: "Fat loss stalled and energy declining — these two are almost always connected.", bottlenecks: [{ tag: "Bottleneck 02 — Fat Loss Stalled", title: "The limiting variable has shifted from intake to output.", body: "After the initial intake suppression phase, fat loss transitions from appetite-driven to output-driven. The compound has done its primary job. The question is whether the body's fat mobilization capacity is keeping pace with the caloric environment." }, { tag: "Bottleneck 03 — Energy Decline", title: "Energy compression is reducing output capacity at the same time.", body: "When energy declines alongside a fat loss plateau, research suggests the caloric deficit has become too aggressive for the body to sustain output. The intake-side mechanism is working. The output side is being compressed by it." }], interaction: "These two bottlenecks are almost always the same problem expressed in two ways. The deficit that created fat loss in Phase 1 has become the ceiling on energy output in Phase 2. Addressing one without the other produces a partial result. The Research Protocol Bible covers the Phase 2 compound logic for fat mobilization alongside the energy pattern identification — the sequence matters significantly.", guide: "rpb" },
  "fatlose,muscle": { tag: "Two Active Bottlenecks", title: "Stalled fat loss while losing muscle — the deficit is working against itself.", bottlenecks: [{ tag: "Bottleneck 02 — Fat Loss Stalled", title: "Fat mobilization capacity is not keeping pace with the deficit.", body: "The intake suppression mechanism has reached its ceiling. The limiting variable has shifted to output — specifically whether the body can mobilize stored fat efficiently at this phase of the protocol." }, { tag: "Bottleneck 01 — Losing Muscle", title: "The caloric deficit is pulling from lean mass as well as fat.", body: "Without a counteracting anabolic signal, sustained caloric restriction breaks down muscle alongside fat. This is not a compound failure — it is the body doing exactly what restricted intake tells it to do when there is no preservation signal." }], interaction: "This combination is one of the clearest signals that the protocol needs a GH secretagogue support layer. The fat loss mechanism is working but the body is using muscle as a secondary fuel source. The Retatrutide, Tesamorelin, and Ipamorelin guide covers the lean mass support stack decisions that address this specific pattern.", guide: "stack" },
  "energy,muscle": { tag: "Two Active Bottlenecks", title: "Low energy and muscle loss together — the deficit is running too deep.", bottlenecks: [{ tag: "Bottleneck 03 — Energy Decline", title: "Output capacity is being compressed by the caloric environment.", body: "Gradual energy decline during a sustained deficit signals that the body's output capacity is being compressed. Research suggests this has three distinct presentations — identifying which one applies changes the compound response significantly." }, { tag: "Bottleneck 01 — Losing Muscle", title: "Lean mass is being broken down alongside fat.", body: "Without an adequate anabolic signal and sufficient protein, the body breaks down muscle for energy alongside fat. This is compounding the energy problem — less lean mass means a lower metabolic floor." }], interaction: "Low energy and muscle loss in combination almost always signals the deficit is running too aggressively for the recovery system to maintain lean mass. The Research Protocol Bible covers the correct sequence — lean mass support first, then energy pattern identification — and why reversing that order tends to accelerate both problems.", guide: "rpb" },
  "energy,mood": { tag: "Two Active Bottlenecks", title: "Low energy and flat mood together — cortisol is likely the upstream driver of both.", bottlenecks: [{ tag: "Bottleneck 03 — Energy Decline", title: "Energy output is being compressed by the protocol environment.", body: "Gradual energy decline during a sustained deficit often involves cortisol elevation as one of the primary mechanisms. The body under prolonged restriction increases cortisol to mobilize energy — and that cortisol elevation becomes its own ceiling." }, { tag: "Bottleneck 06 — Mood and Motivation", title: "Flat mood and depleted drive are almost always downstream cortisol signals.", body: "Mood and motivation loss during a protocol is almost always a downstream signal of elevated cortisol, hormonal suppression, or energy depletion — not a primary cognitive problem." }], interaction: "When energy and mood decline together during an extended protocol, the research consistently points to cortisol elevation as the upstream variable driving both. The Research Protocol Bible covers the cortisol-driven pattern specifically — how to identify whether this is a cortisol ceiling, hormonal suppression, or pure energy depletion, and the compound logic that applies to each.", guide: "rpb" },
  "fatlose,mood": { tag: "Two Active Bottlenecks", title: "Stalled fat loss and flat mood — two signals the system is running at its ceiling.", bottlenecks: [{ tag: "Bottleneck 02 — Fat Loss Stalled", title: "The limiting variable has shifted from intake to output.", body: "Fat loss has transitioned past the appetite suppression phase. The question is whether fat mobilization capacity is keeping pace — and whether cortisol elevation from the extended deficit is part of what is limiting it." }, { tag: "Bottleneck 06 — Mood and Motivation", title: "Flat mood is a downstream signal of an upstream variable.", body: "Mood flatness during an extended protocol is almost always a cortisol or hormonal suppression signal. It tends to appear when the protocol has been running long enough for cumulative restriction stress to become significant." }], interaction: "A fat loss plateau and mood flatness appearing together is a common presentation at weeks 10 to 16 of an extended protocol. Research suggests both are often downstream effects of a cortisol ceiling that has been quietly building. The Research Protocol Bible covers how to identify the cortisol component and why addressing the fat loss bottleneck without it tends to produce a protocol that looks correct on paper but does not respond.", guide: "rpb" },
  "fatlose,sleep": { tag: "Two Active Bottlenecks", title: "Stalled fat loss and disrupted sleep — sleep may be the upstream variable for both.", bottlenecks: [{ tag: "Bottleneck 02 — Fat Loss Stalled", title: "Fat mobilization has reached a ceiling.", body: "The intake suppression mechanism has done its work. The question is whether the output side is keeping pace — and whether poor sleep quality is suppressing the metabolic output that fat mobilization depends on." }, { tag: "Bottleneck 04 — Sleep and Recovery", title: "Sleep disruption during a protocol is often a GLP-1 timing issue first.", body: "Sleep disruption that begins or worsens after starting or escalating a compound is worth investigating as a timing or dose variable before assuming it is a standalone bottleneck." }], interaction: "Poor sleep suppresses growth hormone pulsatility, elevates cortisol, and reduces the metabolic output that fat loss at Phase 2 depends on. When these two appear together, fixing sleep is almost always the correct first move. The Research Protocol Bible covers the sleep and recovery bottleneck protocol and the GLP-1 timing variables that most commonly drive disruption.", guide: "rpb" },
  "energy,fatlose,muscle": { tag: "Three Active Bottlenecks", title: "Stalled fat loss, muscle loss, and low energy — the protocol is running beyond its recovery ceiling.", bottlenecks: [{ tag: "Bottleneck 02 — Fat Loss Stalled", title: "Fat mobilization capacity is not keeping pace with the deficit.", body: "The intake-side mechanism has reached its ceiling. The body needs a fat mobilization signal — but adding one without addressing the other two active bottlenecks runs it on a system that cannot process the output." }, { tag: "Bottleneck 01 — Losing Muscle", title: "Lean mass is being broken down as a secondary fuel source.", body: "Without an adequate anabolic signal, the body breaks down muscle alongside fat during sustained restriction. This is lowering the metabolic floor and compounding the energy problem." }, { tag: "Bottleneck 03 — Energy Decline", title: "Output capacity is being compressed at the same time.", body: "Energy declining across all three of these patterns simultaneously signals the deficit has become more aggressive than the recovery system can manage." }], interaction: "This three-bottleneck combination signals the protocol has moved past what a general framework can diagnose from the outside. The interactions are compounding: muscle loss lowers the metabolic floor, which deepens energy suppression, which reduces the body's ability to mobilize fat efficiently. The Research Protocol Bible covers all three bottlenecks and the sequencing logic that prevents adding compounds in an order that makes things worse before they get better.", guide: "rpb" },
  "energy,fatlose,mood": { tag: "Three Active Bottlenecks", title: "Stalled fat loss, low energy, and flat mood — a cortisol ceiling is likely driving all three.", bottlenecks: [{ tag: "Bottleneck 02 — Fat Loss Stalled", title: "Output capacity is the limiting variable.", body: "Fat loss has transitioned to output-driven. The question is whether cortisol elevation from extended restriction is part of what is suppressing fat mobilization." }, { tag: "Bottleneck 03 — Energy Decline", title: "Energy output is being compressed by the caloric environment.", body: "Gradual energy decline during a sustained deficit often involves cortisol as one of the primary mechanisms. The body under prolonged restriction increases cortisol — and that elevation becomes a ceiling." }, { tag: "Bottleneck 06 — Mood and Motivation", title: "Flat mood is a downstream cortisol or hormonal suppression signal.", body: "Mood flatness during an extended protocol is almost always downstream of elevated cortisol or hormonal suppression — not a standalone problem." }], interaction: "When all three appear together, the research consistently points to a cortisol ceiling as the variable driving the entire picture. The Research Protocol Bible covers this specific pattern — the cortisol-driven triple bottleneck — and the diagnostic sequence for identifying the correct upstream cause before making any compound decision.", guide: "rpb" },
  "mood,muscle,phase3": { tag: "Phase 3 — Multiple Active Bottlenecks", title: "Training decline, muscle loss, and mood flatness together — Phase 3 with compounding signals.", bottlenecks: [{ tag: "Phase 3 — Recovery Strain", title: "The system is under recovery strain from sustained restriction and training load.", body: "Phase 3 occurs when the caloric deficit that drove fat loss in Phase 2 becomes the ceiling on recovery capacity. Training performance declines because the body cannot recover fast enough between sessions." }, { tag: "Bottleneck 01 — Losing Muscle", title: "Lean mass is being broken down alongside the recovery strain.", body: "In Phase 3, lean mass preservation becomes critical. Without an adequate anabolic signal, the combination of caloric restriction and training load accelerates muscle breakdown." }, { tag: "Bottleneck 06 — Mood and Motivation", title: "Flat mood at this stage is almost always a downstream cortisol signal.", body: "Phase 3 increases cortisol load from both the deficit and the training stimulus. Mood and drive flatness here is a physiological signal — not a willpower issue." }], interaction: "This combination in Phase 3 is a systemic problem, not three separate bottlenecks. The Retatrutide, Tesamorelin, and Ipamorelin guide covers Phase 3 recovery strain and the GH secretagogue stack decisions the research supports for this specific presentation.", guide: "stack" },
};

const RESULT_GUIDE_MAP = {
  r_pre_foundation_sleep: { explanation: "The Research Protocol Bible covers sleep as the first Foundation Gate variable — what inadequate sleep does to GH pulsatility, cortisol patterning, and GLP-1 response specifically, and the practical steps for stabilizing it before any protocol begins." },
  r_pre_foundation_protein: { explanation: "The Research Protocol Bible covers protein as a Foundation Gate variable and the specific intake targets relative to lean body mass. It explains why GLP-1-driven appetite suppression so commonly pulls protein down alongside calories and how to correct intake in the context of an active restriction environment." },
  r_pre_foundation_stimulant: { explanation: "The Research Protocol Bible covers stimulant load in the Foundation Gate — what chronic daily use does to the cortisol baseline, how that baseline contaminates the protocol read, and the correct sequencing for reducing stimulant dependence before starting any compound." },
  r_pre_foundation_sleep_protein: { explanation: "The Research Protocol Bible covers both sleep and protein in the Foundation Gate and the correct order for addressing them — sleep first because it governs protein synthesis efficiency, protein second because correcting intake without stable sleep produces a partial result." },
  r_pre_foundation_sleep_stimulant: { explanation: "The Research Protocol Bible covers the compounding interaction between sleep deprivation and stimulant-driven cortisol elevation — why together they produce a cortisol baseline that is resistant to compound-level correction, and the practical steps for addressing both before a protocol begins." },
  r_pre_foundation_protein_stimulant: { explanation: "The Research Protocol Bible covers the interaction between cortisol load and protein adequacy in the Foundation Gate — why the combination is specifically damaging to lean mass outcomes, and the correct order for addressing both before introducing any compound." },
  r_pre_foundation_all: { explanation: "The Research Protocol Bible covers the full Foundation Gate in sequence — all three variables in the correct order with the reasoning behind why sequence matters as much as correction." },
  r_pre_gi_concern: { explanation: "The Retatrutide guide covers GI symptom management in detail — the three distinct presentations, the dose and timing variables that drive each one, and how to distinguish a manageable titration response from a signal that something else needs attention." },
  r_pre_muscle_concern: { explanation: "The Research Protocol Bible covers lean mass preservation across all four protocol phases — which inputs protect it, when a GH support compound becomes the rational addition, and the sequencing logic that prevents the most common lean mass mistakes." },
  r_pre_sleep_concern: { explanation: "The Retatrutide guide covers injection timing in detail — the mechanism behind morning versus evening injection, why timing matters differently for retatrutide than for other GLP-1 compounds, and what the data shows about sleep disruption as a timing variable." },
  r_pre_general_concern: { explanation: "The Research Protocol Bible covers the full phase framework from the start — what each phase looks like, what normal variation looks like at each stage, and how to read results accurately rather than reacting to them." },
  r_pre_glp1_mechanism: { explanation: "The Retatrutide guide covers the full GLP-1 mechanism in plain language — what each receptor does, how that translates into observable results at each phase, and why the same compound works differently for different researchers." },
  r_pre_phase_logic: { explanation: "The Research Protocol Bible is built around the phase framework. It covers all four phases in detail — how to identify which one applies, what the rational compound logic is at each stage, and why the sequence matters more than the compound choice itself." },
  r_pre_compound_match: { explanation: "The Research Protocol Bible covers the GLP-1 starting point decision and the compound selection framework in the first chapter — how to identify which compound fits the actual limiting variable before starting, not after the first plateau." },
  r_pre_support_logic: { explanation: "The Research Protocol Bible covers the support compound decision framework — which bottleneck each support compound addresses, when that bottleneck becomes the active limiting variable, and why the sequencing matters more than the compound itself." },
  r_pre_early_researcher: { explanation: "The Research Protocol Bible is the logical starting point for researchers still building the picture. It covers the full framework — phase identification, compound selection logic, foundation requirements, and the bottleneck diagnostic system — before any protocol decision is made." },
  r_pre_ready: { explanation: "The Research Protocol Bible covers the starting point decision and the compound selection framework in detail — how to confirm the match between your limiting variable and the compound mechanism before committing to a protocol." },
  r_pre_ready_experienced: { explanation: "The Research Protocol Bible covers the compound selection framework from the starting point decision forward — how to identify the actual limiting variable, how to confirm the compound mechanism addresses it, and what the Foundation Gate looks like before starting." },
  r_phase1_early: { explanation: "The Retatrutide guide covers the titration window in detail — what the research shows about weeks one through six, how to read early signals correctly, and why escalating the dose before the effective range is established almost always produces a worse outcome than waiting." },
  r_no_intake: { explanation: "The Retatrutide guide covers the intake suppression mechanism and what an absent appetite response actually signals. It walks through the three most common causes — under-dosing, active titration, and reconstitution error — and how to distinguish between them." },
  r_caloric_audit: { explanation: "The Retatrutide guide covers the Phase 2 metabolic adaptation pattern directly — why a real deficit at week 4 often becomes a marginal one by week 12, and how to run the 7-day intake audit that identifies the actual gap." },
  r_foundation_sleep: { explanation: "The Research Protocol Bible covers the full Foundation Gate framework — the four inputs that determine whether any compound can produce a measurable result. Sleep is Gate 1, and the RPB covers the specific GLP-1 timing and dose variables that most commonly drive disruption." },
  r_foundation_stimulant: { explanation: "The Research Protocol Bible covers the Foundation Gate including the stimulant load variable and why daily use creates a cortisol ceiling that caps what any metabolic compound can accomplish." },
  r_foundation_protein: { explanation: "The Research Protocol Bible covers protein as a Foundation Gate variable and why GLP-1-driven appetite suppression so commonly pulls protein intake down alongside calories." },
  r_bn01: { explanation: "The Retatrutide, Tesamorelin, and Ipamorelin guide covers the lean mass bottleneck directly. It walks through which GH secretagogue combinations the research supports for lean mass preservation during an active GLP-1 protocol, the sequencing logic for introducing them, and what to rule out on the GLP-1 side before adding anything." },
  r_bn02_early: { explanation: "The Retatrutide guide covers the three checks to run before interpreting a recent stall as a bottleneck — precise caloric tracking, dose and timing review, and compound-specific stall pattern identification." },
  r_bn02: { explanation: "The Retatrutide guide covers the Phase 2 fat loss pattern in detail — what drives the transition from intake-driven to output-driven fat loss, which fat mobilization variables the research points to at this stage, and how to evaluate whether your protocol has genuinely entered Phase 2." },
  r_bn02_extended: { explanation: "The Research Protocol Bible covers the extended stall pattern and the framework for identifying overlapping bottlenecks. When a plateau has lasted more than six weeks and standard Phase 2 interventions have not moved it, the RPB gives you the diagnostic sequence for finding the second variable." },
  r_bn03_dose: { explanation: "The Retatrutide guide covers the dose-driven energy drop pattern and how to distinguish it from a genuine energy bottleneck. When energy falls shortly after an escalation, the compound is most likely creating a deficit the body cannot sustain output under." },
  r_bn03: { explanation: "The Research Protocol Bible covers all three presentations of the gradual energy decline pattern and the compound logic that applies to each. Getting the presentation right matters more than the compound choice itself." },
  r_bn03_baseline: { explanation: "The Research Protocol Bible covers the Foundation Gate in full, which is where baseline energy issues almost always trace back to. The RPB walks through all four foundation inputs in order and explains why adding an energy compound before ruling out foundational causes typically amplifies the problem." },
  r_bn04: { explanation: "The Research Protocol Bible covers the sleep and recovery bottleneck protocol — the timing and dose variables to check first, and the specific compounds the research supports for each presentation of sleep disruption during an active protocol." },
  r_bn05: { explanation: "The Retatrutide guide covers GI symptoms in the context of an active GLP-1 protocol and how to distinguish between the three presentations — dose timing driven nausea, gut motility issues from sustained suppression, and mucosal stress from extended restriction." },
  r_bn06: { explanation: "The Research Protocol Bible covers the mood and motivation bottleneck and the diagnostic sequence for identifying whether the upstream driver is cortisol elevation, hormonal suppression, or energy depletion." },
  r_bn07: { explanation: "The Research Protocol Bible covers the dose escalation pattern and the five checks to run before any further dose change. The RPB is direct on this: when escalating the dose does not move the plateau, the dose was not the limiting variable." },
  r_bn07_stall: { explanation: "The Research Protocol Bible covers the pre-escalation checklist and the Phase 2 assessment that almost always identifies the actual limiting variable when a stall triggered a dose increase." },
  r_phase3: { explanation: "The Retatrutide, Tesamorelin, and Ipamorelin guide covers Phase 3 recovery strain and the compound logic that applies when training performance declines alongside a stall. This is a different compound framework than Phase 2." },
  r_phase4: { explanation: "The Research Protocol Bible covers the Phase 4 framework and what the research supports for rebuilding recovery capacity when the sleep-stall-recovery pattern has collapsed together." },
  r_gh_insulin: { explanation: "The Retatrutide, Tesamorelin, and Ipamorelin guide covers the fasted window requirement for GH secretagogues in detail — including how an active GLP-1 protocol changes the required window by slowing gastric emptying." },
  r_gh_bedtime: { explanation: "The Retatrutide, Tesamorelin, and Ipamorelin guide covers injection timing for every GH secretagogue in the stack and explains specifically why bedtime Tesamorelin is the most common timing mistake." },
  r_gh_mixed: { explanation: "The Retatrutide, Tesamorelin, and Ipamorelin guide covers the consistency requirements for GH secretagogue protocols and why varying the injection window produces inconsistent results regardless of compound quality." },
  r_gh_environment: { explanation: "The Retatrutide, Tesamorelin, and Ipamorelin guide covers the environmental inputs that govern GH pulse quality — sleep depth, cortisol context, insulin environment, and somatostatin brake at injection time." },
  r_repair_none: { explanation: "The Research Protocol Bible covers the tissue repair bottleneck including the three most common causes of a null result — reconstitution error, dose inconsistency, and environmental suppression of the repair signal." },
  r_repair_slow: { explanation: "The Research Protocol Bible covers the tissue repair framework and how to evaluate whether the compound combination is correctly matched to the repair presentation." },
  r_longevity_general: { explanation: "The MOTS-C and SS-31 guide covers the general longevity stack decision directly — when each compound becomes the rational choice, how they interact with each other, and why foundational inputs need to be reasonably stable before longevity compounds produce their most meaningful results." },
  r_immune: { explanation: "The MOTS-C and SS-31 guide covers immune resilience and cellular support compounds and how to distinguish between the patterns that each one addresses." },
  r_semax: { explanation: "The Research Protocol Bible covers the cognitive and mood section including Semax, Selank, and DSIP — when each one is the rational choice and how they interact with an active fat loss protocol." },
  r_selank: { explanation: "The Research Protocol Bible covers the full cognitive and mood framework including when Selank is the correct choice over Semax based on the symptom presentation." },
  r_cog_compound: { explanation: "The Research Protocol Bible covers compound interaction logic and how to systematically isolate which variable is driving a cognitive or mood change when the timing points to a recent protocol change." },
};
...
// ─── Protocol Audit CTA Block ─────────────────────────────────────────────────
function AuditCTABlock() {
  return (
    <div className="pt-audit-block">
      <div className="pt-cta-label">If you want a diagnosis, not a framework</div>
      <p className="pt-audit-text">
        The Protocol Audit is a personalized written analysis built from your exact protocol inputs. You complete an 86-question intake covering everything from your metabolic history and training to bloodwork, recovery, and decision pattern. The report identifies what is most likely limiting progress, what is already working, and what the research suggests adjusting over the next four to six weeks.
      </p>
      <p className="pt-audit-text-sub">
        Every tier delivers the same complete written analysis. The difference is turnaround time and whether follow-up is included.
      </p>
      <a className="pt-pill-outline" href={AUDIT_URL} target="_blank" rel="noopener noreferrer">
        View the Protocol Audit
      </a>
    </div>
  );
}
      ...
      <div className="pt-wrap">
        ...
        {screen === "gate" && (
          <div className="pt-gate-screen fade-in">
            ...
            <p className="pt-gate-body">Enter your email to unlock your result and receive three free research guides delivered to your inbox.</p>
            <div className="pt-gate-guides">
              <div className="pt-gate-guides-label">Included free guides</div>
              <a className="pt-gate-guide-link" href="https://cdn.shopify.com/s/files/1/0657/5102/3675/files/Protocol_Stall_Guide.pdf" target="_blank" rel="noopener noreferrer">Protocol Stall Guide →</a>
              <a className="pt-gate-guide-link" href="https://cdn.shopify.com/s/files/1/0657/5102/3675/files/MOTSc_Flowchart.pdf?v=1777398898" target="_blank" rel="noopener noreferrer">MOTS-c Decision Flowchart →</a>
              <a className="pt-gate-guide-link" href="https://cdn.shopify.com/s/files/1/0657/5102/3675/files/Stack_Compatibility_Flowchart.pdf?v=1777477695" target="_blank" rel="noopener noreferrer">Stack Compatibility Flowchart →</a>
            </div>
